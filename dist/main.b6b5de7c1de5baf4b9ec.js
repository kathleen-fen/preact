...
const json_namespaceObject = JSON.parse("{\"title\":\"I am JSON title\"}");
;// CONCATENATED MODULE: ./assets/webpack-logo.png
/* harmony default export */ const webpack_logo = (__webpack_require__.p + "47692505d122dbcae490be2492a60b2e.png");
...
var assets_data = __webpack_require__(169);
...
const post = new Post('Webpack post title', webpack_logo);
